...
public class MainActivity extends AppCompatActivity {
    ...
    /** j'appel les elements quand quand la premiere acticité est cree*/
    ...
    //voici la méthode qui est  exécutée lorsqu'on clique sur le bouton * c'est a dire la multiplication
